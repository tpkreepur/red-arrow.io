...
import logoParsons from '@/images/logos/parsons.svg'
import logoXator from '@/images/logos/xator.png'
import logoAncollege from '@/images/logos/ancollege.jpg'
import logoRedarrow from '@/images/logos/redarrowlogo.svg'
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software designer, cloud architect, founder, and amateur AI
            researcher.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Justin, a software designer and entrepreneur based in Southern
            California. I’m the founder and CEO of Red Arrow Solutions, where I
